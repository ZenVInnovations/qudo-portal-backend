...
/**
 * A new white paper submitted from Qudo Admin. Title and a document link are
 * required; the link may be an absolute URL (hosted PDF) or a site-relative path.
 */
public record CreateWhitePaperRequest(
